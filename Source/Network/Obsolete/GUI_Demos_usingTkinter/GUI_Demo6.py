...
try:
    ...
    from Source.Network.Obsolete.GUI_Demos_usingTkinter.GUI_Demo6_WindowClass import Window
    from Source.Network.Obsolete.GUI_Demos_usingTkinter.GUI_Demo6_WindowClass import drawableObject
