...
try:
    ...
    from Source.Network.Obsolete.GUI_Demos_usingTkinter.GUI_Demo7_WindowClass import Window
    from Source.Network.Obsolete.GUI_Demos_usingTkinter.GUI_Demo7_WindowClass import drawableObject
    from Source.Network.Obsolete.GUI_Demos_usingTkinter.GUI_Demo7_WindowClass import sharedVariableGroup
