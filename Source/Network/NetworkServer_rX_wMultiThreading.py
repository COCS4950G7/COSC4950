...
#NetworkServer_rX_wMultiThreading (revision 10)
#Created: 1/31/2015
#Designed to work with NetworkClient_rX_wMultiThreading

#IMPORTANT!!! (THIS VERSION IS DESIGNED TO ADDRESS THIS ISSUE)
...
#THINGS ADDED/CHANGED WITH THIS VERSION
    #(Implemented)Multithreading and a counter for multithreading
...
class NetworkServer(): #CLASS NAME WILL NOT CHANGE BETWEEN VERSIONS
    ...
    recordOfNumberOfThreadsCreated = 0 #count how many threads have been created
    ...
    def __init__(self, pipeendconnectedtocontroller):
        ...
        thread.start_new_thread(self.handler, (sock, addr))
        self.recordOfNumberOfThreadsCreated = (self.recordOfNumberOfThreadsCreated + 1)
        #self.listOfClients.append((sock, addr)) #add the tuple to the list of clients #HANDLED BY THE THREAD HANDLER
        ...
        try: #server primary while loop try block
            ...
            #/////////////////////////////////////////////////////////////////////////////
                try: #check to see if another client is trying to connect try block
                    ...
                    thread.start_new_thread(self.handler,(sock, addr))
                    self.recordOfNumberOfThreadsCreated= (self.recordOfNumberOfThreadsCreated + 1)
                    #self.listOfClients.append((sock, addr)) #HANDLED BY THREAD HANDLER
        ...
        #.........................................................................
            ...
            #/////////////////////////////////////////////////////////////////////////////
            #Print Number of threads that where created
            #/////////////////////////////////////////////////////////////////////////////
            print " "
            print "Printing Number of Threads That Server Created"
            print "----------------------------------------------"
            if(self.recordOfNumberOfThreadsCreated > 0):
                print "The Server Created " + str(self.recordOfNumberOfThreadsCreated) + " Threads"
            else:
                print "The Server Did Not Create Any Threads"
            print "(END OF PRINTING NUMBER OF THREADS THAT SERVER CREATED)"
            print "-------------------------------------------------------"
            #/////////////////////////////////////////////////////////////////////////////
            #End of Print Number of Threads that where created
            #/////////////////////////////////////////////////////////////////////////////
    ...
    def handler(self,clientSocket, clientAddr):
        try:
            ...
            self.dictionaryOfCurrentClientTasks[clientAddr] = ""
            print "INFO: Client Successfully added to the dictionary of current client tasks"
            clientSocket.close()
            print "INFO: Closed the clientSocket"
        except Exception as inst:
            print "============================================================================================="
            print "ERROR: An exception was thrown in the thread handler Try Block"
            #the exception instance
            print type(inst)
            #srguments stored in .args
            print inst.args
