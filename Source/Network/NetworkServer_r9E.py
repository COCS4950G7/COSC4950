...
#(In progress)Now able to receive a chunk object from the controller class
                    ...
                    try: #check for input from controller try block
                        if(self.pipe.poll()):
                            ...
                            if(type(recv) is Chunk):
                                print "INFO: Received a Chunk Object From the Controller"
                                ...
                                print "INFO: Received a String Object From the Controller"
