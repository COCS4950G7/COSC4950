...
import Dictionary
#import Brute_Force
import NetworkClient_r9C
import NetworkServer_r9C
import Chunk
...
class Controller():
    ...
    networkServer = Process(target=NetworkServer_r9C.NetworkServer, args=(networkPipe,))
    #networkClient = Process(target=NetworkClient.NetworkClient(networkPipe))
    networkClient = Process(target=NetworkClient_r9C.NetworkClient, args=(networkPipe,))
