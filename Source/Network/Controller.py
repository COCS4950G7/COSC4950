...
import Dictionary
#import Brute_Force
import NetworkClient_r9D
import NetworkServer_r9D
import Chunk
...
class Controller():
    ...
    networkServer = Process(target=NetworkServer_r9D.NetworkServer, args=(networkPipe,))
    #networkClient = Process(target=NetworkClient.NetworkClient(networkPipe))
    networkClient = Process(target=NetworkClient_r9D.NetworkClient, args=(networkPipe,))
